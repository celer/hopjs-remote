...
Hop.remoteAPI=function(_url,onComplete,options){
  ...
  if(typeof _url != "string"){
    return onComplete("Invalid url specified:"+_url);
  }
        ...
        (function(objName,methodName,apiOptions){
                ...
                api[objName][methodName]=function(input,onComplete,req){
                  ...
                  if(method.method=="get" || method.method=="delete"){
                          ...
                          request({ uri: destPath+"?"+query, method: method.method, headers: headers, json:true}, function(err,ahr,data){
                          ...
                          var r = request({uri: destPath, method: method.method, json:json, headers: headers, callback: function(err,ahr,data){
                            responseHandler(err,ahr,data,onComplete);
                          } });
